...
import { setOpen, setSelectedIndex } from "../slice/sidebarSlice";
...
const Sidebar = () => {
  ...
  const handleIndexClick = (selectedIndex) => {
        ...
        <ul className="pt-6">
          {Menus.map((menu, index)=>(
            <li
              ...
              className={`${menu.gap ? "mt-9" : "mt-2"} ${index === selectedIndex ? "bg-light-white" : ""} text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md`}
            >
